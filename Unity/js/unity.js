...
function scroll_ad(){
	...
	if(moveHeight != 0){
		float_banner.style.top = float_banner.offsetTop +moveHeight + 20 +'px';
...
//$('#xh').hover(function  () {
//	$(this).html('<img src="img/index/xh.png" />')
//})
//
//$('#niu').hover(function  () {
//	$(this).html('<img src="img/index/niu.png" />')
//})
//
//$('#dzq').hover(function  () {
//	$(this).html('<img src="img/index/dzq.png"  />')
//})
//
//$('#cj').hover(function  () {
//	$(this).html('<img src="img/index/cj.png" />')
//})
